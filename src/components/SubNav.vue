...
<template>
  <div class="prose m-auto mb-8 select-none animate-none! op100!">
    ...
    <div mb-0 flex="~ col gap-1 sm:row sm:gap-3 wrap" text-3xl>
      ...
      <RouterLink to="/research" class="!border-none" :class="route.path === '/research' ? activeStyle : inactiveStyle">
        Research
      </RouterLink>
      <RouterLink to="/news" class="!border-none" :class="route.path === '/news' ? activeStyle : inactiveStyle">
        News
      </RouterLink>
      ...
      <RouterLink to="/food" class="!border-none" :class="route.path === '/food' ? activeStyle : inactiveStyle">
        Food
      </RouterLink>
    </div>
  </div>
