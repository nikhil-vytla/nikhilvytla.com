  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <a href="https://www.linkedin.com/in/nikhil-vytla" target="_blank" title="LinkedIn" class="lt-md:hidden">
          <div i-garden-linkedin-stroke-16 />
        </a>
        <a href="https://twitter.com/nikhilxvytla" target="_blank" title="Twitter" class="lt-md:hidden">
